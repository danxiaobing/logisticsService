...
class App_OrderController extends Rpc
{
    ...
    public function searchOrderFunc($params){
        $L = new App_OrderModel(Yaf_Registry::get("db"),null,Yaf_Registry::get("gy_db"));
    ...
    public function getOrderInfoFunc($orderid){
        $O = new App_OrderModel(Yaf_Registry::get("db"),null,Yaf_Registry::get("gy_db"));
