...
class Examine_CarrierModel
{
    ...
    public function getCarrierList($params){
        ...
        if (isset($params['company_name']) && $params['company_name'] != '') {
            $filter[] = " companies.`company_name` like %" . $params['company_name']."% ";
        }
        if (isset($params['company_user']) && $params['company_user'] != '') {
            $filter[] = " companies.`company_user` like %" . $params['company_user']."% ";
        }
        if (isset($params['company_code']) && $params['company_code'] != '') {
            $filter[] = " companies.`company_code` like %" . $params['company_code']."% ";
        }
        ...
        #sql语句
        $sql = "SELECT gl_companies.*,conf_area.area,conf_province.province,conf_city.city,gl_companies_business.type as business,gl_companies_products.type as products FROM gl_companies 
    ...
    public function getCarrier($id){
        ...
        #sql语句
        $sql = "SELECT gl_companies.*,gl_products.type FROM gl_companies 
    ...
    public function showfile($id){
        $sql = "SELECT * FROM `gl_companies` WHERE id = ".intval($id);
