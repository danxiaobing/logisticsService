...
include 'IClientProfile.php';
use \Profile\IClientProfile;


include __DIR__.'/../Auth/Credential.php';
include __DIR__.'/../Auth/ShaHmac1Signer.php';



use \Auth\Credential;
use \Auth\RamRoleArnCredential;
use \Auth\EcsRamRoleCredential;
