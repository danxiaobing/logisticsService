<?php
include 'ProductDomain.php';
include 'Endpoint.php';
include 'EndpointProvider.php';
use Regioin\ProductDomain;
use Regioin\Endpoint;
use Regioin\EndpointProvider;
//var_dump(new ProductDomain('1','2'));die;
/*
